...
def print_retrieved_contexts(retriever, user_question: str):
    ...
    try:
        ...
        if not retrieved_nodes:
            print("⚠️  No relevant contexts found in the vector store.\n")
            return []
...
def main():
    ...
    if not os.getenv("OPENAI_API_KEY"):
        ...
        if api_key:
            ...
            print("\n❌ Cannot proceed without OpenAI API key. Exiting...\n")
            return
    ...
    try:
        ...
        if not user_question:
            print("\n⚠️  No question provided. Using default question.\n")
        ...
        while True:
            ...
            if another in ['n', 'no']:
                print("\n👋 Thank you for using the Specific Task Expert Agent!\n")
                break
